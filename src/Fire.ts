...
export class Fire {
  public FireMesh: THREE.Mesh;

  public constructor(fireTex: THREE.Texture, color: THREE.Color) {
    ...
    THREE.Mesh.call( this.FireMesh, new THREE.BoxGeometry( 1.0, 1.0, 1.0 ), fireMaterial );
  }

  // public update(time) {
  //   var invModelMatrix = this.FireMesh.material.uniforms.invModelMatrix.value;

  //   this.FireMesh.updateMatrixWorld();
  //   invModelMatrix.getInverse( this.FireMesh.matrixWorld );

  //   if( time !== undefined ) {
  //       this.FireMesh.material.uniforms.time.value = time;
  //   }

  //   this.FireMesh.material.uniforms.invModelMatrix.value = invModelMatrix;

  //   this.FireMesh.material.uniforms.scale.value = this.FireMesh.scale;
  // }
}
